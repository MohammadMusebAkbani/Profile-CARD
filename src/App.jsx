...
function App() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col w-full max-w-[50rem] h-[30rem] items-center justify-center mx-auto bg-gray-400 rounded-3xl">
        <div className="flex flex-col h-[400px] w-[300px] bg-white rounded-lg shadow-lg relative overflow-hidden">
          ...
          <img
            src={imageUrl}
            alt="Profile"
            className="absolute top-[6rem] left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full border-[4px] border-blue-500 object-cover shadow-md bg-amber-50"
          />
          {/* Content section */}
          <div className="flex flex-col items-center flex-1 pt-10 gap-1">
